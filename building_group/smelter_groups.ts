...
export class NearlySmelterGroup extends BuildingList {
    ...
    constructor(
        ...
        this.ingress_belts = bp.addBuildings(new BeltList(area_index, 12, [local[0], local[1] + 1, 5], undefined, belt_level)) as BeltList
        this.egress_belts = bp.addBuildings(new BeltList(area_index, 12, [local[0], local[1] + 3, 5], undefined, belt_level)) as BeltList
        ...
        this.smelters_00.forEach((smelter, index, array) => {
            this.egress_inserters.push(bp.addBuilding(
                new Inserter(area_index, 
                    ...
                    this.egress_belts.getList()[index*2].header.index, smelter.header.index, 
                    -1, 0, 0, 1)
            ) as Inserter )
            ...
            this.ingress_inserters.push(bp.addBuilding(
                new Inserter(area_index, 
                    ...
                    smelter.header.index, this.ingress_belts.getList()[index*2].header.index, 
                    1, -1, 0, 1)
            ) as Inserter )
        });
        ...
        this.smelters_13.forEach((smelter, index, array) => {
            this.egress_inserters.push(bp.addBuilding(
                new Inserter(area_index, 
                    ...
                    this.egress_belts.getList()[index*2+1].header.index, smelter.header.index, 
                    -1, 8, 0, 1)
            ) as Inserter )
            ...
            this.ingress_inserters.push(bp.addBuilding(
                new Inserter(area_index, 
                    ...
                    smelter.header.index, this.ingress_belts.getList()[index*2+1].header.index, 
                    7, -1, 0, 1)
            ) as Inserter )
        });
    }
